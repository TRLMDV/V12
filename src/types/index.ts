...
export interface BankAccount {
  ...
  creationDate?: string; // New: Optional creation date for the account
}
...
export interface Settings {
  ...
  showWeatherOnDashboard: boolean; // New: Toggle for weather widget visibility
  defaultWeatherCity: string; // New: Default city for weather widget
...
// --- Recycle Bin Types ---
export type CollectionKey = 'products' | 'suppliers' | 'customers' | 'warehouses' | 'purchaseOrders' | 'sellOrders' | 'incomingPayments' | 'outgoingPayments' | 'productMovements' | 'packingUnits' | 'paymentCategories' | 'bankAccounts' | 'utilizationOrders' | 'quickButtons' | 'reminders';
