const core = {
  ...
  totalRevenuePlusVatCollected: 'Total Revenue + Total VAT Collected',
  vatCollectedFromSales: 'VAT collected from sales',
  expensesTotal: 'Expenses',
  expensesFromCategories: 'All categorized outgoing payments (fees and manual categories)',
  grossProfitMinusExpenses: 'Gross Profit - Expenses',
  cleanProfitAfterExpenses: 'Clean Profit (after expenses)',
  ...
  noPaymentCategoriesFound: 'No payment categories found.',
};
